      ...
      body: GestureAccessibilityWidget(
        ...
        onTap: (position) {
          ...
          if ((controller.sinal1[ponto - 1] == '1' && cela == 1) ||
            ...
            if (cela == 1)
              controller.sinal1 =
                  controller.sinal1.replaceRange(ponto - 1, ponto, '0');
            if (cela == 2)
              controller.sinal2 =
                  controller.sinal2.replaceRange(ponto - 1, ponto, '0');
          } else {
            if (cela == 1)
              controller.sinal1 =
                  controller.sinal1.replaceRange(ponto - 1, ponto, '1');
            if (cela == 2)
              controller.sinal2 =
                  controller.sinal2.replaceRange(ponto - 1, ponto, '1');
          }
